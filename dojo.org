...
1. Cria uma função no módulo principal que faça o "pattern matching" com status 200 e 404. Abra o shell e teste com repositórios conhecidos e com inexistentes para ver o resultado.
...
Trata-se de mais um tipo do Elixir: um struct. Não precisamos entrar em detalhes agora, mas ele é apenas um mapa especial do Elixir. Pode-se fazer um pattern matching normalmente nele:
