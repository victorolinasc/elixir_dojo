...
Existem ainda outra forma de depender de outros módulos que é usando a palavra reservada "use". Com ela você importa o módulo em questão e "requer" suas macros. Há mais diferenças, mas veremos mais a frente em maiores detalhes.
...
1. Refatore nosso OlaMundo para esconder a necessidade do pid.
